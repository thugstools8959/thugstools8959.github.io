...
window.onbeforeunload = function (event) {
  var message = 'KHÔNG ĐƯỢC TẮT CÁI NÀY ĐI, TẮT ĐỒNG NGHĨA LÀ CHỊU LÀM VỢ CỦA TUI ĐÓ! ♥ =)) CÓ CHẮC TẮT KHÔNG? :3';
...
<body onload="popup('<p>Tui hỏi cái này, bạn phải trả lời thật lòng đó nghe chưa. Không trả lời thật lòng là tui đánh bỏ moẹ bạn nha :v.</p></br>'); on()" onunload="s()">
<div id="bg"></div>
<div id="myModal" class="reveal-modal large">
	...
	<!-- ___________________________________SỬA TRANG THỨ 3 NGAY ĐÂY (3)_______________________________________________-->
	  ...
	  <p>TẠI SAO BẠN LẠI YÊU TUI ? 🙄🙄  Nhập câu trả lời xuống bên dưới và bấm GỬI ĐI</br></br></p>
      <form id="f" name="f">
...
<h1> <?php if($_GET['em']==null) echo 'EM'; else echo $_GET['em']; ?> <b>CÓ YÊU TUI KHÔNG ?</b></h1>
			
<h2><?php if($_GET['em']==null) echo 'EM'; else echo $_GET['em']; ?> BẠN MÀ TẮT CÁI NÀY ĐỒNG NGHĨA BẠN SẼ LÀM VỢ CỦA TUI. SUY NGHĨ ĐI !</br>
CÓ YÊU TUI KHÔNG ? TRẢ LỜI NHANH BẠN! ♥ =))</h2>
...
<center>
<div id="co"> 
<a href="#" data-reveal-id="myModal">CÓ! <?php if($_GET['em']==null) echo 'EM'; else echo $_GET['em']; ?> TUI YÊU</a>
</div> 

<div id="lbNo" style="position:absolute; left: 700px; top: 300px;"> 
<input type="button" value="BẠN MƠ À" style="cursor:pointer;" onMouseMove="move()" > 
</div>
<div> <img src="🙄🙄"></div>
</center> 

<iframe src="https://www.nhaccuatui.com/mh/background/m8B5khMBtV5Z" width="1" height="1" frameborder="0" allowfullscreen></iframe> <!-- (3) Thay đổi nhạc tại đây-->
