        ...
        $(document).ready(function() {
            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").html("</br><h2>AI CŨNG NÓI VẬY MÀ :V</h2>");
					$("#divResult").fadeIn(2000,function()
							{
							$("#divResult2").fadeOut(0);
							$("#divResult2").html("<p>♥ ỪA THÌ TUI BIẾT TUI ĐẸP TRAI THẬT. NHƯNG THÔI TUI CŨNG ĐÀNH CHỊU THIỆT YÊU MẦY VẬY .:V</p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>VẬY HÃY ĐỂ TRÁI TIM TUI THUỘC VỀ BẠN MỘT LẦN NHÉ!  :V</p></br>");
